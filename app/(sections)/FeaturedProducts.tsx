  ...
  return (
    <section className="bg-[#FFFFFF] py-8 md:py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-[#F28C82] mb-6 text-center">
            Our Featured Products
          </h2>
          <p className="text-base text-[#9CA3AF] mb-8 text-center max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {productList.map((product) => (
              ...
              >
                ...
                <h3 className="text-base font-medium text-[#6B7280] mt-3 mb-1 text-center">
                  {product.title}
                </h3>
                <p className="text-sm text-[#9CA3AF] mb-3 text-center line-clamp-2">
                  {product.description}
                </p>
          ...
          <div className="text-center mt-8">
            <Link href="/products">
              <span className="inline-block bg-transparent border border-[#F28C82] text-[#F28C82] text-sm font-medium px-5 py-2 rounded-md hover:bg-[#F28C82] hover:text-white transition-colors duration-200">
                View All Products
              </span>
            </Link>
          </div>
